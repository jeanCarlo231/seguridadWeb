...
import beans.sessions.VentasFacade;
...
public class VentasController implements Serializable {
    ...
    @EJB
    private beans.sessions.VentasFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Venta creada con exito!");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Venta editada con exito!");
            return "List";
        } catch (Exception e) {
            JsfUtil.addSuccessMessage("¡Lo sentimos la operación no pudo completarse intente mas tarde!");
            return "List";
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Venta eliminada con exito!");
        } catch (Exception e) {
            JsfUtil.addSuccessMessage("¡Lo sentimos la operación no pudo completarse intente mas tarde!");
        }
    }
